...
const DoctorDetails = () => {
  ...
  const{id}=useParams()
  const{data:doctor,loading,error}=useFetchData(`${BASE_URL}/api/doctor/${id}`)
 console.log(doctor)
 const{name,photo,averageRating,about,qualifications,experiences,bio,totalRating,ticketPrice,timeSlots,reviews}=doctor
  return (
    <section>
